CUDA_VISIBLE_DEVICES=0,1,2,3 python -m torch.distributed.launch --nproc_per_node=4 --master_port=10001 \
	--use_env /lustre/scratch/client/vinai/users/trangpvh1/repo/FAN/main.py  --data_dir /cm/archive/thoth/dataset/ImageNet/ --model fan_tiny_12_p16_224 -b 128 --sched cosine --epochs 300 \
